document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "Hiyoshop UI");
        setContent('wm', 'textContent', `© 2025 ${settings.apiSettings.creator}. All rights reserved.` || "© 2025 Hiyoshop. All rights reserved.");
        setContent('header', 'textContent', settings.name || "Hiyoshop UI");
        setContent('name', 'textContent', settings.name || "Hiyoshop UI");
